...
Step 1: Identify 1-3 key entities from the Article which are missing from the previously generated Summary.
...
Guidelines:
- The first summary should be long (4-5 sentences, ~80 words) yet highly non-specific, containing little information beyind the entities marked as missing.
User overly verbose language and filters (e.g., "This article discusses") to reach ~80 words.
- Make every word count: re-write the previous summary to improve flow and make space for additional entities.
- Make space with fusion, compression and removal of uninformative phrases like "The article discusses".
- The summaries should become highly dense and concise yet self-contained e.g., easily understood without the Article.
- Missing entities can appear anywhere in the new summary.
- Never drop entities from the previous summary. If space can't be made, add fewer new entities.

Remember, use the exact same numer of workds for each summary.
